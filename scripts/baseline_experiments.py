...
# ============================================================
# STEP 3 — DEFINE AND RUN BASELINES
# ============================================================
...
# ============================================================
# STEP 6 — DETAILED REPORT FOR BEST BASELINE
# ============================================================

print("\n" + "=" * 60)
print("DETAILED REPORT — TF-IDF + LinearSVC")
print("=" * 60)
...
ax.set_ylabel('Score')
ax.set_title('OSS Threat Detection - Method Comparison')
ax.set_xticks(x)
...
print(f"Majority class:               {results['Majority Class']['accuracy_mean']:.1%}")
...
print(f"\nImprovement over best baseline: +{improvement:.1f} percentage points")
print(f"\nPaper sentence:")
print(f"  Our taxonomy-aligned LLM achieves {llm_acc:.0%} accuracy,")
